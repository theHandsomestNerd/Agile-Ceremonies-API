/*! For license information please see main.62804a0c.js.LICENSE.txt */
...
`,Ko=Kt.div`
  ...
  margin-top: var(--spacing-xs);
`,Go=t=>{var r,n;let{agents:a,selectedAgent:o,onAgentChange:i}=t;const[s,l]=(0,e.useState)(0),c=e.useRef(null);e.useEffect((()=>{c.current&&l(c.current.offsetWidth);const e=()=>{c.current&&l(c.current.offsetWidth)};return window.addEventListener("resize",e),()=>window.removeEventListener("resize",e)}),[]);const u=a.findIndex((e=>e.key===o))||0,d=(null===(r=a[u])||void 0===r?void 0:r.key)||"Nat",p=(null===(n=Ca[d])||void 0===n?void 0:n.color)||"var(--color-primary)";return(0,Xt.jsxs)(No,{ref:c,children:[(0,Xt.jsx)(Mo,{offset:-u*s,children:a.map(((e,t)=>{const r=Ca[e.key];return(0,Xt.jsx)(Lo,{isActive:t===u,borderColor:(null===r||void 0===r?void 0:r.color)||"var(--color-primary)",children:(0,Xt.jsxs)(Fo,{children:[(0,Xt.jsx)($o,{bgColor:(null===r||void 0===r?void 0:r.color)||"var(--color-primary)",children:(null===r||void 0===r?void 0:r.short)||e.name.charAt(0)}),(0,Xt.jsxs)(Bo,{children:[(0,Xt.jsx)(qo,{children:e.name}),(0,Xt.jsx)(Wo,{children:e.role})]})]})},e.key)}))}),(0,Xt.jsxs)(Ko,{children:[(0,Xt.jsx)(Ho,{direction:"left",onClick:()=>{const e=0===u?a.length-1:u-1;i(a[e].key)},color:p,children:(0,Xt.jsx)(lr,{})}),(0,Xt.jsx)(Uo,{children:a.map(((e,t)=>{var r;return(0,Xt.jsx)(Vo,{active:t===u,color:(null===(r=Ca[e.key])||void 0===r?void 0:r.color)||"var(--color-primary)",onClick:()=>i(e.key)},t)}))}),(0,Xt.jsx)(Ho,{direction:"right",onClick:()=>{const e=u===a.length-1?0:u+1;i(a[e].key)},color:p,children:(0,Xt.jsx)(sr,{})})]})]})},Yo=Kt.div`
  display: flex;
...
`,Jo=Kt.div`
  max-width: 80%;
  padding: var(--spacing-sm) var(--spacing-md);
  border-radius: ${e=>e.isUser?"var(--border-radius-lg) var(--border-radius-lg) 0 var(--border-radius-lg)":"var(--border-radius-lg) var(--border-radius-lg) var(--border-radius-lg) 0"};
  background: ${e=>{if(e.isUser)return"var(--color-neutral-200)";switch(e.agentKey){case"Nat":return"var(--color-nat-gradient)";case"Brian":return"var(--color-brian-gradient)";case"Reqqy":return"var(--color-reqqy-gradient)";case"Josh":return"var(--color-josh-gradient)";case"James":return"var(--color-james-gradient)";case"Terrell":return"var(--color-terrell-gradient)";case"Antosh":return"var(--color-antosh-gradient)";case"Man-Man":return"var(--color-manman-gradient)";case"Lia":return"var(--color-lia-gradient)";case"Compass":return"var(--color-compass-gradient)";default:return"var(--color-primary-gradient, linear-gradient(135deg, var(--color-primary) 0%, var(--color-primary-light) 100%))"}}};
  color: ${e=>e.isUser?"var(--color-neutral-900)":"white"};
  box-shadow: var(--shadow-sm);
`,Qo=Kt.p`
  margin: 0;
  line-height: var(--line-height-normal);
  word-break: break-word;
`,Xo=e=>{let{message:t,isUser:r,agentKey:n}=e;return(0,Xt.jsx)(Yo,{isUser:r,children:(0,Xt.jsx)(Jo,{isUser:r,agentKey:n,children:(0,Xt.jsx)(Qo,{children:t})})})},Zo=[{key:"Compass",name:"Compass",role:"HR/Router"},{key:"Nat",name:"Nat",role:"CEO/AI PM"},{key:"Brian",name:"Brian",role:"Product Manager"},{key:"Reqqy",name:"Reqqy",role:"Requirements Agent"},{key:"Josh",name:"Josh",role:"Graphic Designer"},{key:"James",name:"James",role:"Backend Developer"},{key:"Terrell",name:"Terrell",role:"Frontend Developer"},{key:"Antosh",name:"Antosh",role:"Testing & Analytics"},{key:"Manman",name:"Man-Man",role:"Maintenance"},{key:"Lia",name:"Lia",role:"Social Media"}],ei=()=>(0,Xt.jsx)(qa,{children:(0,Xt.jsx)("path",{d:"M12 2C6.48 2 2 6.48 2 12c0 5.52 4.48 10 10 10s10-4.48 10-10c0-5.52-4.48-10-10-10zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v2h-2zm0 4h2v6h-2z"})}),ti=()=>(0,Xt.jsx)(qa,{children:(0,Xt.jsx)("path",{d:"M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"})}),ri=()=>(0,Xt.jsx)(qa,{children:(0,Xt.jsx)("path",{d:"M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"})}),ni=Yt`
    0%, 100% {
        opacity: 1;
    }
    50% {
...
`),oi=Kt.span`
    ...
    font-weight: 700;
    margin: 0 3px;
    animation: ${ni} 1.4s infinite;
    animation-delay: ${e=>e.delay}ms;
`,ii=()=>(0,Xt.jsxs)(ai,{"aria-live":"polite","aria-atomic":"true",children:[(0,Xt.jsx)(oi,{delay:0,children:"\u2022"}),(0,Xt.jsx)(oi,{delay:200,children:"\u2022"}),(0,Xt.jsx)(oi,{delay:400,children:"\u2022"})]}),si=Kt.div`
    position: fixed;
    top: 0;
    right: 0;
    height: 100vh;
