...
`),Uo=Kt.span`
  ...
  font-weight: 700;
  margin: 0 3px;
  animation: ${qo} 1.4s infinite;
  animation-delay: ${e=>e.delay}ms;
`,Vo=()=>(0,Xt.jsxs)(Wo,{"aria-live":"polite","aria-atomic":"true",children:[(0,Xt.jsx)(Uo,{delay:0,children:"\u2022"}),(0,Xt.jsx)(Uo,{delay:200,children:"\u2022"}),(0,Xt.jsx)(Uo,{delay:400,children:"\u2022"})]}),Ho=Kt.div`
  position: fixed;
  top: 0;
  right: 0;
  height: 100vh;
...
`,Qo=Kt.span`
  ...
  text-align: right;
`,Xo=Kt(Jr)`
  background: ${e=>e.you?"var(--color-neutral-200)":"linear-gradient(90deg, var(--color-josh-primary) 35%, var(--color-josh-secondary) 100%)"};
  color: ${e=>e.you?"var(--color-neutral-900)":"var(--color-neutral-100)"};
  border: 1px solid ${e=>e.you?"rgba(230, 230, 240, 0.7)":"rgba(139, 92, 246, 0.3)"};
  /* Different shapes for human vs agent */
  border-radius: ${e=>e.you?"18px 18px 4px 18px":"18px 18px 18px 4px"};
