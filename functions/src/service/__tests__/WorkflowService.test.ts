...
describe('WorkflowService', () => {
    ...
    describe('triggerWorkflow', () => {
        it('should trigger a workflow and save a log', async () => {
            ...
            (WorkflowRepository.getWorkflowById as jest.Mock).mockResolvedValueOnce(mockWorkflow);
            const saveLogSpy = jest.spyOn(WorkflowService, 'saveWorkflowLog').mockResolvedValueOnce('Workflow log saved');
            ...
            expect(saveLogSpy).toHaveBeenCalledWith('123', expect.objectContaining({
